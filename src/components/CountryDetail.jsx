...
function CountryDetail() { 
  ...
  useEffect(()=>{
    ...
    .then(([data]) => {
      ...
      tld: data.tld,
      currencies: Object.values(data.currencies).map((currncy) => currncy.name).join(', '),
  ...
  if(notFound){
    return <div style={{color:'red', margin:20, fontWeight:"bold", fontSize:20}}>Oops ! Sorry Country Not Found</div>
  }
